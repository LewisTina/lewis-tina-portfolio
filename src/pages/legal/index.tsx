        ...
        <Layout title={`${t('legal_mentions')} - Lewis TINA`}>
            <main className="min-h-screen w-full relative flex flex-col items-center">
                ...
                <div className="w-full flex justify-center">
                    <div className="w-full flex py-32 min-h-screen max-w-[1535px]">
                        <Sidebar/>
                        <div className="px-16 pt-8 w-[840px] h-auto md:px-4 lg:px-8 relative">

                        <div className="relative">
                            <h1 className="text-5xl capitalize sticky">
                                {t('legal_mentions')}
                            </h1>
                        ...
                        <div className="pt-20 relative" id="legal" title={t("legal")}>
                            <h2 className="text-4xl text-gray-500 capitalize sticky">
                                {t('legal')}
                            </h2>

                            <p className={`text-justify my-4 ${dm_sans.className}`}>
                             ...
                             <br/>
                                ...
                                {t('contact_publication_director')} : <strong>contact@lewistina.com</strong> <br/>
                             <br/>
                                {t('developer')} : <strong>ABOUTOU TINA Pierre Lewis</strong> <br/>
                                {t('contact_developer')} : <strong><a href="mailto:contact@lewistina.com?subject=Contact%20a%20partir%20des%20mentions%20l%C3%A9gales%20via%20le%20site%20lewistina.com">contact@lewistina.com</a></strong> <br/>
                             <br/>
