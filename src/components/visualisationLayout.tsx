    ...
    return (
        <main className="">
            <Head>
                ...
                <meta property="twitter:title" content={`${projectTitle} | Lewis Tina's Portfolio`}/>
                ...
                <meta name="keywords" content="lewis - tina - lewis tina - pierre lewis - pierre aboutou - aboutou - pierre lewis aboutou tina - aboutou tina - pierre aboutou - lewistina - profolio - ternay - lyon - developper - développeur - fullstack - frontend - backend - mobile - dev - designer - graphic - design - designer - skills"/> 
            </Head>
            {children}
        </main>
  );
