                ...
                <div className={`w-full flex flex-col justify-start relative items-start gap-10 md:gap-32`}>
                    {
                        Object.keys(projects).map((_keyName) => {
                            ...
                            return (
                                <>
                                <div 
                                    className="w-full h-auto border-2 md:border-0 border-light-grey/25 lg:h-[unset] sm:w-full relative overflow-hidden cursor-pointer"
                                    ...
                                    <div className="border-r-2 border-light-grey/25 md:border-r-0 md:border-b-2 w-full h-auto flex group">
