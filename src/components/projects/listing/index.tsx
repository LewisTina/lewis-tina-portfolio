    ...
    return(
        <section className={`flex flex-col items-center justify-start pt-40 pb-52 px-10 md:px-0 lg:px-6`} id="my_project">
            <div className={`flex flex-col justify-start relative items-start max-w-[1535px] w-full rounded-3xl text-darkest dark:text-white`}>
                <div className={`w-full flex flex-col justify-start relative items-start gap-10 md:gap-20`}>
                    {
                        Object.keys(projects).map((_keyName) => {
                            ...
                            return (
                                <>
                                <div 
                                    className="w-full h-auto border-2 bg-white dark:bg-darkest md:border-x-0 border-light-grey/25 lg:h-[unset] sm:w-full relative overflow-hidden">
                                    <div className="grid grid-cols-[1fr,1.25fr] w-full relative lg:grid-cols-[1fr,1fr] md:grid-cols-1">
                                        <div 
                                            ...
                                            onClick={()=>{router.push(`visualisation/${keyName}`)}}>
                                        ...
                                        <div className="flex flex-col w-full">
                                            ...
                                            </div>
                                            {
                                                ...
                                                <></>
                                                :
                                                <div className="px-12 lg:p-4 py-6 lg:py-4 w-full border-t-2 border-light-grey/25 flex flex-wrap justify-start items-center">
                                                    {
                                                        behanceLink &&
