...
export default function Cover(props: any){
    ...
    return(
        <section className="relative h-[calc(100vh+7rem)] md:h-[calc(100vh-7rem)] lg:h-[calc(70vh)] min-h-[700px] md:min-h-[45rem] flex justify-center w-full bg-white dark:bg-darkest bg-cover-bg bg-no-repeat bg-right-top bg-contain z-0 max-h-[1114px] dela-gothic-one px-16 pb-16 md:pb-4" id="home">
            ...
            <div className="absolute h-full w-full flex flex-col justify-center md:items-start max-w-[1535px] md:px-4 lg:px-8">
